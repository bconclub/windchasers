...
import CabinCrewPageClient from "../cabin-crew/page.client";

export const metadata: Metadata = {
  title: "Cabin Crew Program Bangalore | WindChasers Aviation Academy",
  description:
    "Launch your cabin crew career with WindChasers. Affordable training, mock flights, placement assistance, and direct airline connections in Bangalore.",
};
...
async function getCabinCrewAssets() {
  ...
  return { heroVideoSrc: null, galleryImages: [] as string[] };
}

export default async function CabinCrewProgramPage() {
