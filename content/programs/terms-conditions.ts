  ...
  blocks: [
    {
      ...
      title: "Agreement",
      paragraphs: [
        "These Terms and Conditions, along with the privacy policy or other terms (“Terms”) constitute a binding agreement by and between WindChasers (“Website Owner” or “we” or “us” or “our”) and you (“you” or “your”) and relate to your use of our website, goods (as applicable) or services (as applicable) (collectively, “Services”).",
    ...
    {
      type: "richtext",
      title: "Intellectual Property and Conduct",
      paragraphs: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "All concerns or communications relating to these Terms must be communicated to us using the contact information provided on this website, including aviators@windchasers.in. WindChasers is based in Bangalore, India.",
      ],
    },
  ],
  ctaTitle: "Questions about these terms?",
  ctaText:
    "Get in touch with our team at aviators@windchasers.in.",
};
