...
export const article: Article = {
  title: 'The Best Aviation Academy in India for Pilot Training: A Career-Ready Curriculum',
  ...
  sections: [
    ...
    {
      heading: 'A Multi-Stage Pathway to the Sky',
      paragraphs: [
        'At WindChasers, we have designed a progressive pathway for aspiring pilots. Each stage is not just a box to tick but a milestone that adds depth to your skills and broadens your aviation vision.',
      ],
      bullets: [
    ...
    {
      heading: 'Specialization and Edge: Advanced Ratings',
      paragraphs: ['Every airline is looking for more than just a CPL. Our academy offers specialized ratings that give you an edge in the industry.'],
      bullets: [
        'Multi-Engine Rating: Learn to manage complex aircraft systems and dual engines, a necessity for commercial flight operations.',
        'Night Rating Program: Master night-time navigation, lighting systems, and the human factors that influence performance during dark hours.',
        'Airline Transport Pilot License (ATPL): The final step toward commanding commercial jets, combining classroom theory with strategic insight for captaincy.',
        'Certified Flight Instructor (CFI): Transform skilled flyers into skilled educators who teach and inspire future pilots.',
      ],
    },
    {
    ...
    {
      heading: 'Diploma in Aviation: Broaden Your Horizons',
      paragraphs: [
        'Our Diploma in Aviation caters to those looking to explore operational, regulatory, and commercial aspects of aviation in addition to flying. This course opens doors to airport management, airline operations, and aviation logistics.',
      ],
    },
    {
    ...
    {
      heading: 'Tailored for the Indian Sky and Global Standards',
      paragraphs: [
        'As one of the best aviation academies in India, we take pride in combining globally benchmarked training with an understanding of India’s regulatory, geographical, and climatic flying environment. We’re approved by the Directorate General of Civil Aviation (DGCA), ensuring our students graduate with credentials that meet all licensing standards and airline prerequisites.',
      ],
    },
    {
      heading: 'Flexibility for Modern Learners',
      paragraphs: [
        'We understand that many of our students juggle college, work, or family commitments. That’s why our curriculum is designed to be flexible, with hybrid class options, modular learning, and customizable flight schedules. Whether you’re starting after 12th grade or shifting careers in your 30s, our programs are built to accommodate your journey.',
      ],
    },
    {
