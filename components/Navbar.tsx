...
import { Phone, ChevronDown, CalendarDays, MapPin } from "lucide-react";
import {
              ...
              <div className="flex flex-col min-h-full pt-20 pb-8 px-8">
                ...
                <div className="flex flex-col gap-3 mt-7">
                  <Link
                    ...
                    className="flex items-center justify-center gap-2 py-3 rounded-lg bg-gold text-dark font-bold hover:bg-gold/90 transition-colors"
                  >
                ...
                <div className="mt-7 pt-5 border-t border-white/10">
                  <a
                    href="tel:+919591004043"
                    onClick={() => onCallClick()}
                    className="flex items-center gap-2.5 text-white font-semibold hover:text-gold transition-colors"
                  >
                    <Phone className="w-4 h-4 text-gold flex-shrink-0" />
                    <span>+91 95910 04043</span>
                  </a>
                  <a
                    href="https://maps.google.com/maps?q=WindChasers+Aviation+Academy+Kothanur+Bengaluru"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-3 flex items-start gap-2.5 text-sm text-white/55 hover:text-gold transition-colors"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="mt-3 block rounded-lg overflow-hidden border border-white/10 hover:border-gold/40 transition-colors"
                    aria-label="Open WindChasers location in Google Maps"
                  >
                    <iframe
