          ...
          <div className="flex justify-between items-center h-20">
            ...
            {showCompact ? (
              <div className="flex items-center gap-2">
                ...
                {/* WhatsApp pill is scoped to the program funnel pages
                    (home, pilot-training, DGCA, helicopter, international)
                    via useWaCapture. Webinar pages keep their own group-
                    invite link. Every other page hides the pill entirely —
                    the user explicitly wanted no WA chat button on event,
                    thank-you, or service pages. */}
                {useWaCapture ? (
                  <button
                    type="button"
                    onClick={() => {
                ...
                ) : (isWebinarParent || isWebinarStudents) ? (
                  <a
